# 2026 FedEx University Founding-Year Media
...
Each completed event should be stored as a dated Markdown file using:

`YYYY-MM-DD-short-event-name.md`

When the precise fictional date is intentionally left open, use an ordered event number until the timeline is fixed:

`event-01-short-event-name.md`
